...
const IdaEVolta = () => {
  ...
  const buscarCompensacao = () => {
    ...
    if (resultado) {
      setValorCompensacao(resultado.valor.toFixed(2));
      setCO2EmitidoValue(resultado.co2Emitido.toFixed(2));
      setFlorestaProtegida(resultado.florestaProtegida.toFixed(1));
  ...
  return (
    <View style={styles.container}>
      ...
      {origem.length >= 3 && destino.length >= 3 && (
        <Button title="Calcular" color="#26944d" onPress={buscarCompensacao} />
      )}
